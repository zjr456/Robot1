...
def generate_launch_description():
    ...
    # kobuki_urdf = os.path.join(kobuki_nav_prefix,'urdf', 'kobuki.urdf')
    # kobuki_urdf = os.path.join(tbot_sim_path,'urdf', 'kobuki_generated_from_sdf.urdf')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen',
            parameters=[],
            arguments=['-entity','kobuki', '-database', 'kobuki_model'])
])